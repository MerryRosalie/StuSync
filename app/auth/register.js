      ...
      <View className="flex-1 relative">
        ...
        <ScrollView className="flex-1 mt-[220px]">
          <View className="bg-white dark:bg-dark-background px-5 py-8 rounded-t-[30px] min-h-[500px]">
            ...
            <Text className="font-inter-medium text-lg mb-2 dark:text-dark-text-default">Name</Text>
            <TextInput
            ...
            <Text className="font-inter-medium text-lg my-2 dark:text-dark-text-default">Username</Text>
            <TextInput
            ...
            />
              ...
              <Text className="font-inter-medium text-lg my-2 dark:text-dark-text-default">Email</Text>
            <TextInput
            ...
            <Text className="font-inter-medium text-lg my-2 dark:text-dark-text-default">Password</Text>
            <TextInput
            ...
            <Text className="font-inter-medium text-lg my-2 dark:text-dark-text-default">Confirm Password</Text>
            <TextInput
            ...
            <View className="flex-row justify-center items-center mt-4">
              <Text className="font-inter-regular dark:text-dark-text-default">Have an account? </Text>
              <Link href="/auth/login" className="font-inter-medium text-purple-default">
                Log In
              </Link>
            </View>
