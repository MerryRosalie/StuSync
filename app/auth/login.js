  ...
  return (
    <SafeAreaView className="flex justify-start items-center bg-purple-secondary dark:bg-dark-purple-secondary h-full">
      ...
      <View className="bg-white dark:bg-dark-background w-full h-full px-5 py-12 rounded-t-[30px]">
        ...
        <Text className="font-inter-medium text-lg mb-2 dark:text-dark-text-default">Email</Text>
        <TextInput
        ...
        <View className="flex-row justify-center items-center mt-4">
          <Text className="font-inter-regular dark:text-dark-text-default">Don't have an account? </Text>
          <Link href="/auth/register" className="font-inter-medium text-purple-default">
            Sign Up
          </Link>
        </View>
